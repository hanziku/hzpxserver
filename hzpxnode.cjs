...
const serializeGlyphUnit=(glyphunits)=>glyphunits.map(it=>it.join(':')).join('$');
...
exports.setFontJs = setFontJs;
exports.setFontPtk = setFontPtk;
exports.setFontTSV = setFontTSV;
exports.splitPinx = splitPinx;
exports.validIRE = validIRE;
